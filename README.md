...
* **mmjstool**: is a CLI to help with some task related to the mattermost-mobile, desktop and plugin webapp development. The core web app extracts its own translations with `formatjs extract` and does not use this tool.
